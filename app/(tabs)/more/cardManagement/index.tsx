    ...
    return (
      <View style={[styles.container, { paddingTop: paddinTop }]}>
         ...
         animationOut={"fadeOut"}
          ...
          onBackButtonPress={() => {
            ...
            <View style={styles.modalView}>
              <Text style={styles.modalTextDes}>Are you sure you want to remove card</Text>
              <Pressable
                style={styles.button}
        ...
        <View style={styles.itemsContainer}>
          <Pressable
            style={styles.item}
            onPress={()=>router.navigate('/(tabs)/more/cardManagement/addCardForm')}
          >
          ...
          <Pressable
            style={styles.item}
            onPress={()=>router.navigate('/(tabs)/more/cardManagement/cardDetails')}

          >
            <Text style={styles.itemText}>View Card Details</Text>
              <ArrowRightIC width={20} height={20} />
          ...
          <Pressable
            ...
            onPress={()=> setModalVisible(!modalVisible)}
          >
            <Text style={styles.itemText}>Remove Card</Text>
              <ArrowRightIC width={20} height={20} />
            
          </Pressable>
          <Pressable
            style={styles.item}
            onPress={()=>router.navigate('/(tabs)/more/cardManagement/setDefaultCard')}
          >
            <Text style={styles.itemText}>Set Default Card</Text>
              <ArrowRightIC width={20} height={20} />
          ...
          <Pressable
            style={styles.item}
            onPress={()=>router.navigate('/(tabs)/more/cardManagement/privacySettings')}
