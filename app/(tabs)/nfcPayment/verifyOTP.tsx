...
const verifyOTP = () => {
  ...
  return (
    <View style={[styles.container, { paddingTop: paddinTop }]}>
      <TouchableOpacity onPress={()=> router.back()} style={{ width: '100%', paddingTop:5, paddingHorizontal:20, paddingBottom: 30,}}>
      ...
      >
         {/* Heading */}
          ...
          <View style={styles.formContainer}>
                ...
                <CustomTextInput keyboardType='phone-pad' inputMode='numeric' maxLength={11} onChange={setOtpValues} placeholder='Enter OTP' value={otpValues} />
