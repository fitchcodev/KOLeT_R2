  ...
  return (
    ...
    >
      ...
      >
        {/* Heading */}
        <Animated.View
            entering={FadeInDown.delay(200).springify()} style={styles.header}>
          <Logo />
        ...
        <Animated.View style={{ alignSelf: 'flex-end', paddingHorizontal: 4,}} entering={FadeInRight.delay(600).springify()}>
          <Text onPress={()=> router.navigate("/auth/forgotPassword")} style={{fontSize: 12,
letterSpacing: 0.1,
fontFamily: "Montserrat-Regular",
color: Colors.main.primary,}}>Forgot Password?</Text>
        </Animated.View>
        ...
        >
          ...
          <View style={styles.footerBottom}>
            ...
            <View style={styles.socialLink}>
              <TouchableOpacity style={{backgroundColor: '#0866FF', padding: 10, borderCurve:'continuous', borderRadius: 10}}><FB width={25} height={25}/></TouchableOpacity>
              <TouchableOpacity style={{backgroundColor: 'black', padding: 10, borderCurve:'continuous', borderRadius: 10}}><XIC width={25} height={25}/></TouchableOpacity>
              <TouchableOpacity style={{backgroundColor: 'white', padding:10, borderCurve:'continuous', borderRadius: 10}}><GoogleIc width={25} height={25}/></TouchableOpacity>
              <TouchableOpacity style={{backgroundColor: 'black', padding:10, borderCurve:'continuous', borderRadius: 10}}><AppleIC width={25} height={25}/></TouchableOpacity>
            </View>
          </View>
        </Animated.View>
      </ScrollView>
