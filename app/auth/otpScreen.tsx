...
const OtpScreen = () => {
  ...
  return (
    <View style={[styles.container, { paddingTop: paddinTop }]}>
      <TouchableOpacity onPress={()=> router.back()} style={{ width: '100%', paddingVertical:5, paddingHorizontal:20}}>
      ...
      >
              ...
              >
                {otpValues.map((digit, index) => (
                  <Animated.View
                    ...
                    style={[styles.otpFieldContainer, {   borderColor: otpValues[index].length >0? Colors.main.primary: Colors.main.description}]}
                    key={index}
                  >
                    <TextInput
        ...
        <Animated.View entering={FadeIn.delay(800)} style={styles.progressBar}>
          ...
          <View style={ !checkButtonDisabled() ? styles.progressBarItemActive : styles.progressBarItemInactive} />
        ...
        >
          ...
          <TouchableOpacity disabled={checkButtonDisabled()}  onPress={handleButton}  style={[styles.footerBtn, {backgroundColor: Colors.main.primary, opacity: !checkButtonDisabled() ? 1: 0.5}]}>
